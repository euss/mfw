...
# Priority: 300
# Description: Add the 3.60 app keys to appldr 3.55
    
# Option --add-360keys-to-appldr355: add the 3.60 keys to appldr 3.55


namespace eval ::add_360keys_to_appldr355 {

    array set ::add_360keys_to_appldr355::options {
        --add-360keys-to-appldr355 true
    }

    proc main { } {
        set self "appldr"

        ::modify_coreos_file $self ::add_360keys_to_appldr355::patch_self
    }

    proc patch_self {self} {
		::modify_self_file_sce $self ::add_360keys_to_appldr355::patch_elf
    }

    proc patch_elf {elf} {
        if {$::add_360keys_to_appldr355::options(--add-360keys-to-appldr355)} {
